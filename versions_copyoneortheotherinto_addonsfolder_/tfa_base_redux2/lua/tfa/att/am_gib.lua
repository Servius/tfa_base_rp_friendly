...
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "Always gibs enemies", TFA.AttachmentColors["+"], "10% more damage", TFA.AttachmentColors["-"], "20% more recoil", TFA.AttachmentColors["-"], "10% more spread"  }
