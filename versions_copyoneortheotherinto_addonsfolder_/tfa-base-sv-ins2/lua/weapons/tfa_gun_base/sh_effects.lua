...
function SWEP:ShootEffectsCustom( ifp )
	if CLIENT and self:OwnerIsValid() and culldistancecvar and self:GetOwner():GetPos():Distance(EyePos()) > culldistancecvar:GetFloat() and culldistancecvar:GetInt() ~= -1 then return end
